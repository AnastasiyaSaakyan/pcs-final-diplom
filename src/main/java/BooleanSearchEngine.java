...
public class BooleanSearchEngine implements SearchEngine {
    private static final String stopWordsNameFile = "stop-ru.txt";
    private final Map<String, List<PageEntry>> allWordsMap = new HashMap<>();
    ...
    public BooleanSearchEngine(File pdfsDir) throws Exception {
        ...
        indexingStopWords(stopWordsNameFile);
    }
